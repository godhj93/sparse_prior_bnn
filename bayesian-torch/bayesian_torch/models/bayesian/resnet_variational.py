...
class BasicBlock(nn.Module):
    ...
    def __init__(self, in_planes, planes, stride=1, option='A', prior_type=None):
...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, num_classes=10, prior_type=None):
        ...
        self.layer1 = self._make_layer(block, 16, num_blocks[0], stride=1, prior_type=prior_type)
        self.layer2 = self._make_layer(block, 32, num_blocks[1], stride=2, prior_type=prior_type)
        self.layer3 = self._make_layer(block, 64, num_blocks[2], stride=2, prior_type=prior_type)
...
def resnet20(num_classes, prior_type):
    return ResNet(BasicBlock, [3, 3, 3], num_classes=num_classes, prior_type=prior_type)
